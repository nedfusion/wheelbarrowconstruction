  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(/Wuta Residences 2.jpg)'
        }}
      >
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-white pt-24 md:pt-32">
        <div className="max-w-4xl">
          {/* Main Heading */}
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold leading-tight mb-8">
            Redefining
            <span className="block text-wine-200 italic">Nigeria's Built</span>
            <span className="block">Environment</span>
          </h1>
          
          {/* Description */}
          <p className="text-xl md:text-2xl mb-12 text-white/90 leading-relaxed max-w-3xl font-light">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mb-16">
            ...
            <button
              ...
              className="group border-2 border-white text-white hover:bg-white hover:text-wine-900 px-10 py-5 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105"
            >
              View Our Portfolio
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-12">
            <div className="text-center sm:text-left group">
              <div className="flex items-center justify-center sm:justify-start space-x-4 mb-3">
                <div className="bg-white/10 backdrop-blur-sm p-3 rounded-lg group-hover:bg-white/20 transition-colors duration-300">
                  <Award className="h-8 w-8 text-wine-200" />
                </div>
                <span className="text-4xl lg:text-5xl font-serif font-bold">100+</span>
              </div>
              <p className="text-white/80 text-lg">Projects Delivered</p>
            </div>
            
            <div className="text-center sm:text-left group">
              <div className="flex items-center justify-center sm:justify-start space-x-4 mb-3">
                <div className="bg-white/10 backdrop-blur-sm p-3 rounded-lg group-hover:bg-white/20 transition-colors duration-300">
                  <Users className="h-8 w-8 text-wine-200" />
                </div>
            ...
            <div className="text-center sm:text-left group">
              <div className="flex items-center justify-center sm:justify-start space-x-4 mb-3">
                <div className="bg-white/10 backdrop-blur-sm p-3 rounded-lg group-hover:bg-white/20 transition-colors duration-300">
                  <Clock className="h-8 w-8 text-wine-200" />
                </div>
                <span className="text-4xl lg:text-5xl font-serif font-bold">100%</span>
              </div>
              <p className="text-white/80 text-lg">Client Satisfaction</p>
            </div>
          </div>
        </div>
      </div>
